...
const BodyComponent = () => {
  ...
  const [preguntasIngresadas, setPreguntasIngresadas] = useState({});
  ...
  const getData = async () => {
    try {
      ...
      const data: any = await fetch(`/api/Pruebas/GetPruebasUser?SubSede=${SubSede}&IdRol=${IdRol}&IdUser=${IdUser}&IdPrueba=${IdPrueba || ""}`
      ).then((res) => res.json());
              ...
              <form>
                ...
                <div className="mb-2">
                  ...
                  <Select
                    ...
                    getOptionLabel={(item) => `${item.NombrePrograma} (Prueba # ${+1})`}
                          ...
                          <div className="flex flex-col flex-wrap justify-between items-center">
                            ...
                            <div className="flex justify-center items-center">
                              ...
                              <svg
                                onClick={() => {
                                  const preguntasPush = []
                                  for (let i = 0; i < item.preguntas.length; i++) {
                                    const element = item.preguntas[i];
                                
                                    // Verificamos si element[i] es un objeto válido
                                    if (element && typeof element === 'object') {
                                      // Asignamos el nuevo nombre a la propiedad
                                      element.Id = element.id;
                                      element.Pregunta = element.pregunta;
                                      element.TipoPregunta = element.tipo;
                                
                                      delete element.id;
                                      delete element.pregunta;
                                      delete element.tipo;
                                      delete element.DateCreate;
                                      delete element.prueba;
                                      delete element.IdDocente;
                                      delete element.competencia;
                                      preguntasPush.push(element);
                                    }
                                  }

                                  setPreguntasIngresadas(preguntasPush);
                                  setDataEnvia({
                                    ...dataEnvia,
