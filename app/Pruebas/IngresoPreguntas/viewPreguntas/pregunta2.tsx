...
export function Pregunta2({ data }: Props) {
        ...
        <>
            ...
            <div className="grid md:grid-cols-2 items-center gap-2">
                {respuestas && respuestas.map((info: any, key: number) => {
                    ...
                    return (
                        <>
                            <div className={`${correctas.indexOf(abecedario[key]) >= 0 && "border-2 border-green-800 p-2"}`}>
                                ...
                                <span className="text-2xl">{correctas.indexOf(abecedario[key]) >= 0 && (<>&#10004;</>)}</span>
                            </div>
                        </>
                    )
                })}
