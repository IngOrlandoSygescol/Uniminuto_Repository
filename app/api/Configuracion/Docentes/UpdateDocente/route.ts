...
export async function PUT(req: NextRequest) {
  try {
    ...
    const [UpdateDocente]: any = await connectionPool.query(
      `update dcne set dcne_ape1='${apellido1}',dcne_ape2='${apellido2 || ""
      }',dcne_nom1='${nombre1}', dcne_nom2='${nombre2}',dcne_email_perso='${Correo}',tipo_docu_id='${TipoDocumento}',dcne_num_docu='${Documento}',dcne_genero='${Genero}',cu='${Cu}'  where i=${IdDocente}`
    );
