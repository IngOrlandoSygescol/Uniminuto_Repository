...
const ModalAdd = ({ setShowModal, setDocentes }: Props) => {
  ...
  const handerSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const ResDocentes = await fetch(`/api/Configuracion/Docentes/GetDocentes?SubSede=${Values?.IdSubSede || 0}`).then((res) => res.json());
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              ...
              <div className="mb-2">
                ...
                {/* <Select
                  ...
                  onChange={(item: any) => { setValues({ ...Values, Cu: item.label }) }}
                  placeholder="Seleccione programa"
                  required
                  className="text-gray-600"
                /> */}
