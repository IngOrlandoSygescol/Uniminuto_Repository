...
const ModalAsignarDocente = ({
  ...
  const [hora, setHora] = useState(ValuesInfo.Hora);
  const [minutos, setMinutos] = useState(ValuesInfo.Minutos);
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const filteredData = DocentesDb?.filter((el: any) => {
                    ...
                    const programa = el?.NombrePrograma?.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();
                  ...
                  setAsignacion({ ...Asignacion, Docentes: filteredData });
                }}
                autoFocus
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setCompetenciaGenerica((prev: any) => {
                          const updatedCompetencias = [...prev];
                          updatedCompetencias[Asignacion?.Competencia?.index].Hora = selectedHour;
                          return updatedCompetencias;
                        });
                      }}
                      value={hora}
                    >
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setMinutos(selectedMinutes);
                        setCompetenciaGenerica((prev: any) => {
                          const updatedCompetencias = [...prev];
                          updatedCompetencias[Asignacion?.Competencia?.index].Minutos = selectedMinutes;
                          return updatedCompetencias;
                        });
                      }}
                      value={minutos}
