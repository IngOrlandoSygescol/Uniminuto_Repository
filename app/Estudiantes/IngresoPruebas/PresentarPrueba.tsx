      ...
      if (NewArray?.length == 0) {
        ...
        if (newCompetencias?.length == 0) {
          ...
          Swal.fire({
            ...
            text: 'Usted ha finalizado la prueba. Si desea ver los resultados, debe dar clic en la sección "Reporte de Pruebas" y luego en "Descargar el Reporte", el cual le será entregado en formato PDF.',
    ...
    <>
      <div className="bg-[#000236]/100 transition duration-150 ease-in-out z-10 fixed top-0 right-0 bottom-0 left-0">
        <div className="grid sm:grid-cols-2  md:grid-cols-10 md:gap-4 h-screen">
          <div className="text-white md:col-span-3 md:overflow-y-auto dark:bg-gray-900">
            <MenuPruebas
              Preguntas={Preguntas}
